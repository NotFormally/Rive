...
const enFixes = {
  ...
  "f7_title": "The Harbor Master (Reservations)",
  "f7_desc": "Sync all your visiting fleets from Libro, Resy, and Zenchef. Webhooks and automatic polling — a clear port.",
  "f7_ex1": "Receive Libro reservations instantly as the boats dock online.",
  "f7_ex2": "Consolidate arriving guests, cancellations, and no-shows in a single deck view.",
  "f7_ex3": "Cross-reference passenger data to anticipate the demands of your next voyage.",
...
const frFixes = {
  ...
  "f7_title": "La Capitainerie (Réservations)",
  "f7_desc": "Synchronisez les arrivées de Libro, Resy et Zenchef. Un quai dégagé sans aucune double saisie manuelle.",
