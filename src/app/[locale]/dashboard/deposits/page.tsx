    ...
    <>
      <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
        ...
        <div className="px-4 sm:px-8 flex items-center gap-6 text-sm font-medium overflow-x-auto">
          <a href="/dashboard/deposits" className="py-3 border-b-2 border-indigo-600 text-indigo-600 whitespace-nowrap">Tableau de Bord</a>
          <a href="/dashboard/deposits/history" className="py-3 border-b-2 border-transparent text-slate-500 hover:text-slate-900 transition-colors whitespace-nowrap">Historique des Retours</a>
        </div>
      </header>
