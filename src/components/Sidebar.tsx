...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: t("nav_menu"), href: "/dashboard/menu", icon: MenuSquare, show: true },
    { name: t("nav_foodcost"), href: "/dashboard/food-cost", icon: Calculator, show: true },
    { name: t("nav_engineering"), href: "/dashboard/engineering", icon: Compass, show: true },
    { name: t("nav_deposits"), href: "/dashboard/deposits", icon: Recycle, show: true },
    { name: t("nav_variance"), href: "/dashboard/variance", icon: Droplets, show: true },
    { name: t("nav_reservations"), href: "/dashboard/reservations", icon: CalendarDays, show: true },
    { name: t("nav_smartprep"), href: "/dashboard/prep-list", icon: Brain, show: true },
    { name: t("nav_social"), href: "/dashboard/social", icon: Share2, show: true },
    { name: t("nav_production"), href: "/dashboard/production", icon: Beer, show: true },
