...
-- Provider Policies
DROP POLICY IF EXISTS "Users can view their own providers" ON public.reservation_providers;
...
DROP POLICY IF EXISTS "Users can manage their own providers" ON public.reservation_providers;
