...
DROP POLICY IF EXISTS "Users can view their own prep lists" ON public.prep_lists;
...
DROP POLICY IF EXISTS "Users can manage their own prep lists" ON public.prep_lists;
...
DROP POLICY IF EXISTS "Users can view their own prep list items" ON public.prep_list_items;
...
DROP POLICY IF EXISTS "Users can manage their own prep list items" ON public.prep_list_items;
...
DROP POLICY IF EXISTS "Users can view their own prep list ingredients" ON public.prep_list_ingredients;
...
DROP POLICY IF EXISTS "Users can manage their own prep list ingredients" ON public.prep_list_ingredients;
...
DROP POLICY IF EXISTS "Users can view their own confidence modifiers" ON public.prep_confidence_modifiers;
...
DROP POLICY IF EXISTS "Users can manage their own confidence modifiers" ON public.prep_confidence_modifiers;
