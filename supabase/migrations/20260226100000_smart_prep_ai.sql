...
DROP POLICY IF EXISTS "Users can view their own context logs" ON public.restaurant_context_logs;
...
DROP POLICY IF EXISTS "Users can manage their own context logs" ON public.restaurant_context_logs;
