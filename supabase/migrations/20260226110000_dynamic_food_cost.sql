...
DROP POLICY IF EXISTS "Team select food_cost_alerts" ON public.food_cost_alerts;
...
DROP POLICY IF EXISTS "Team insert food_cost_alerts" ON public.food_cost_alerts;
...
DROP POLICY IF EXISTS "Team update food_cost_alerts" ON public.food_cost_alerts;
CREATE POLICY "Team update food_cost_alerts" ON public.food_cost_alerts FOR UPDATE
  USING (restaurant_id IN (SELECT user_restaurant_ids()));

DROP POLICY IF EXISTS "Team delete food_cost_alerts" ON public.food_cost_alerts;
