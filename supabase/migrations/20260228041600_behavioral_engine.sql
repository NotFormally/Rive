...
DROP POLICY IF EXISTS "Users can view own restaurant intelligence score" ON restaurant_intelligence_score;
...
DROP POLICY IF EXISTS "Users can update own restaurant intelligence score" ON restaurant_intelligence_score;
...
DROP POLICY IF EXISTS "Users can insert own restaurant intelligence score" ON restaurant_intelligence_score;
...
DROP POLICY IF EXISTS "Users can view own restaurant insights" ON daily_insights;
...
DROP POLICY IF EXISTS "Service role can insert insights" ON daily_insights;
...
DROP POLICY IF EXISTS "Users can view own chef streaks" ON chef_streaks;
...
DROP POLICY IF EXISTS "Users can update own chef streaks" ON chef_streaks;
...
DROP POLICY IF EXISTS "Users can insert own chef streaks" ON chef_streaks;
...
DROP POLICY IF EXISTS "Users can insert own referral links" ON referral_links;
...
DROP POLICY IF EXISTS "Service role can insert monthly reports" ON monthly_reports;
